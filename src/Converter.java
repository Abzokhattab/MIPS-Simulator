...
public class Converter {
	...
	protected static void instructions(String op, String[] data) {
		...
		if(op.equals("and")) {
			...
			rType(data[1], data[2], data[3], "00000", "100000");
		}else if(op.equals("or")){
			rType(data[1], data[2], data[3], "00000", "100101");
		}else if(op.equals("nor")){
			rType(data[1], data[2], data[3], "00000", "100111");
...
r=String.format("%s %05d %05d %s", opc, registerNumber(rs), registerNumber(rt), Integer.toBinaryString(Integer.parseInt(data)));
	...
	protected static void iTypeLabel(String opc, String rs, String rt, String data) {
		//op code
		r=String.format("%s %05d %05d %s", opc, registerNumber(rs), registerNumber(rt), data);
	}
